...
import cn.xwj.frame.skin.SkinCompatViewInflater;
import cn.xwj.frame.skin.SkinManager;
import cn.xwj.frame.skin.attr.SkinAttr;
import cn.xwj.frame.skin.attr.SkinView;
import cn.xwj.frame.skin.support.SkinAttrSupport;

/**
 * Author: xw
 * Date: 2018-03-07 09:48:32
 * Description: BaseSkinActivity <this is description>.
 */
...
public abstract class BaseSkinActivity extends BaseActivity implements LayoutInflaterFactory{
    ...
    public final View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        if (view != null) {
            Log.e(TAG, "拦截 view: " + view);
            //解析属性， background,src,textColor
